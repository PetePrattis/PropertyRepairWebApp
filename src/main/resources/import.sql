...
INSERT INTO OWNER (owner_AFM, firstname, lastname, owner_address, owner_telephone, owner_email, owner_password, property_type, user_role) VALUES ('123456789', 'fname1', 'lname1', 'address1', '6955555555', 'user1@mail.com', '$2a$10$5PK0V1TJeR3OKxbEcE7deuSaBz74YjcY/l9sgi4YyrVY8mhjMTyHq', 'MAISONETTE', 'ADMIN');
INSERT INTO OWNER (owner_AFM, firstname, lastname, owner_address, owner_telephone, owner_email, owner_password, property_type, user_role) VALUES ('1234567892', 'fname2', 'lname2', 'address2', '6955555555', 'user2@mail.com', '$2a$10$00721rJWTj0Vz4.bbymFa.rm/AEDLFYkrvThkDYOlEkxloYeK4r9C', 'MAISONETTE', 'OWNER');
